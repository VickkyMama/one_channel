...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=1, num_classes=1000, embed_dim=96, depth=[6, 6, 6, 6, 6, 6],
                 split_size=[3, 5, 7],
        ...
        self.stage4 = nn.ModuleList(
            [RSTB(
                ...
                qkv_bias=qkv_bias, qk_scale=qk_scale, split_size=split_size[-1],
                drop=drop_rate, attn_drop=attn_drop_rate,
                drop_path=dpr[np.sum(depth[:-1]) + i], norm_layer=norm_layer, downsample=None, use_checkpoint=use_checkpoint,
...
def CSWin_64_12211_tiny_224(pretrained=False, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=64, depth=[6, 6, 6, 6, 6, 6],
                             split_size=[1, 2, 7, 7], num_heads=[6, 6, 6, 6, 6, 6], mlp_ratio=4., **kwargs)
...
def CSWin_96_24322_base_224(pretrained=False, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=96, depth=[6, 6, 6, 6, 6, 6],
                             split_size=[1, 2, 7, 7], num_heads=[6, 6, 6, 6, 6, 6], mlp_ratio=4., **kwargs)
    model.default_cfg = default_cfgs['cswin_224']
    return model
...
def CSWin_144_24322_large_224(pretrained=False, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=144, depth=[6, 6, 6, 6, 6, 6],
                             split_size=[1, 2, 7, 7], num_heads=[6, 6, 6, 6, 6, 6], mlp_ratio=4., **kwargs)
    model.default_cfg = default_cfgs['cswin_224']
    return model
...
def CSWin_96_24322_base_384(pretrained=False, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=96, depth=[6, 6, 6, 6, 6, 6],
                             split_size=[1, 2, 12, 12], num_heads=[6, 6, 6, 6, 6, 6], mlp_ratio=4., **kwargs)
